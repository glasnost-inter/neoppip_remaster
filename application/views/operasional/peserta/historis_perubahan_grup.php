                    ...
                    <table id="datatable-buttons" class="table table-striped table-bordered">
                       <thead>
						<tr>
                                                        <th>NO</th>								
                                                        <th>TGL_PINDAH</th>
                                                        <th>NOMOR_GRUP_ASAL</th>
                                                        <th>NOMOR_GRUP_BARU</th>
                                                        <th>USERREKAM</th>
                                                        <th>TGLREKAM</th>
						</tr>
						</thead>
						...
						$no = 1;    
							...
							<tr>									
                                                            ...
                                                            <td><?php echo $data->NOMOR_GRUP_ASAL;?></td>
                                                            <td><?php echo $data->NOMOR_GRUP_BARU;?></td>
                                                            <td><?php echo $data->USERREKAM;?></td>
                                                            <td><?php echo $data->TGLREKAM;?></td>
							</tr>
							<?php
							}
                                                }            
