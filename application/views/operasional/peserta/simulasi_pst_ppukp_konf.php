        ...
        <div class="box">
            ...
            <div id="collapse3" class="body">  
                ...
                <form class="form-horizontal" method="post" action="<?php echo base_url('index.php/cpeserta/simpan_simulasi_ppukp_konf/'.$nomorpeserta) ?>">                    
                    ...
                    <input type="hidden" value="<?php echo $nomorgrup;?>" name="nomorgrup" class="form-control col-lg-6">
                    <?php if($nilaiperintah<>0){ 
                            $mindana = abs($akumulasi_iuran-$nilaiperintah);
                        ?>
                        <input type="submit" value="Simpan" onClick="popitup('<?php echo base_url('index.php/cpoppeserta/isi_nosurat_konf_selisih/'.$nomorpeserta.'/'.$kodeklaim.'/'.str_replace("/", "-", $tgltransaksi)) ?>',850,575)" class="btn btn-primary">                        
