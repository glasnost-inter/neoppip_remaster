...
class PDF extends FPDF{
    ...
    function Header()
    {
            ...
            $this->Cell(255,4,'LAMPIRAN PESERTA KLAIM',0,0,'C');
            $this->Ln();
            $this->Ln();
            $this->Ln();
            ...
            $this->Cell(25,5,'TGL ESTIMASI BAYAR','1',0,'C',true);                        
            $this->Cell(30,5,'FEE PENDIRI','1',0,'C',true);
            $this->Cell(30,5,'PAJAK FEE','1',0,'C',true);
            $this->Cell(50,5,'NO REKENING','1',0,'C',true);
            $this->Cell(50,5,'NAMA BANK','1',0,'C',true);
            $this->Cell(50,5,'PEMILIK REKENING','1',0,'C',true);
            $this->Ln();
    }
    ...
    function Table($hasil)
    {
        ...
        */
        ...
        foreach($hasil as $data) {            
            ...
            $this->Cell(25,5,$data->TGL_SIP,'1',0,'C');            
            $this->Cell(30,5,number_format($data->FEE_PENDIRI,2,',','.'),'1',0,'R');
            $this->Cell(30,5,number_format($data->PAJAK,2,',','.'),'1',0,'R');
            $this->Cell(50,5,$data->NO_REKENING,'1',0,'L');
            $this->Cell(50,5,$data->NAMA_BANK,'1',0,'L');
            $this->Cell(50,5,$data->NAMA,'1',0,'L');
            $this->Ln();
