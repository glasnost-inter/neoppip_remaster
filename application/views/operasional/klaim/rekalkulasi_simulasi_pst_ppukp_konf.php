    ...
    <div class="col-lg-12">
        ...
        <div class="box">
            ...
            <div id="collapse3" class="body">
                <form class="form-horizontal" method="post" action="<?php echo base_url('index.php/cklaim/simulasi_ppukp_konf/'.$nomorpeserta) ?>">
	...
	<div class="box">
        ...
        <div class="box">
            ...
            <div id="collapse3" class="body">  
                ...
                <form class="form-horizontal" method="post" action="<?php echo base_url('index.php/cklaim/update_simulasi_ppukp_konf/'.$nomorpeserta) ?>">                    
