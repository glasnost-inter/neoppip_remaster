            ...
            <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
              <div class="menu_section">
                ...
                <ul class="nav side-menu">
                  ...
                  <li><a><i class="fa fa-edit"></i> Operasional <span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
						<li><a>Kepesertaan<span class="fa fa-chevron-down"></span></a>
							<ul class="nav child_menu">
								<li class="sub_menu"><a>Pendaftaran<span class="fa fa-chevron-down"></a>
									<ul class="nav child_menu">
										<li class="sub_menu"><a href="level2.html">Pendaftaran Peserta Individu</a>
										</li>
										<li><a href="#level2_1">Pendaftaran Grup</a>
										</li>																	
									 </ul>
								</li>                            					
							</ul>
