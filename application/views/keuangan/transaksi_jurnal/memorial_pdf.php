...
class PDF extends FPDF{
    ...
    function Header()
    {
            ...
            $this->Cell(180,6,'BUKTI MEMORIAL',0,0,'C');
            $this->SetFont('Arial','',10);
            $this->Ln();
            $this->Ln();
            $this->Ln();
            ...
            $this->Cell(58,6,'KETERANGAN',1,0,'C');
            $this->Cell(30,6,'REK',1,0,'C');
            $this->Cell(40,6,'DEBET',1,0,'C');
            $this->Cell(40,6,'KREDIT',1,0,'C');
            $this->Ln();			
    }
    ...
    {		
			$this->SetFont('Arial','B',10);
			$this->Cell(68,6,'TOTAL',1,0,'R');
			$this->Cell(30,6,'',1,0,'R');
			$this->Cell(40,6,number_format($this->TOTAL_NOMINAL,2,',','.'),1,0,'C');			
			$this->Cell(40,6,number_format($this->TOTAL_NOMINAL,2,',','.'),1,0,'C');			
			$this->Ln();
            $this->Ln();            
            $this->SetLeftMargin(15); 
    ...
    function Table($hasil)
    {
        ...
        */
        ...
        foreach($hasil as $data) { 		
			...
			$this->Cell(58,20,$data->NAMA_AKUN,'L',0,'C');
			$this->Cell(30,20,$data->AKUN,'L',0,'C');
			$this->Cell(40,20,number_format(($data->POSISI=='D'?$data->IURAN:0),2,',','.'),'L',0,'C');
			$this->Cell(40,20,number_format(($data->POSISI=='K'?$data->IURAN:0),2,',','.'),'L',0,'C');
